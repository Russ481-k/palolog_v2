...
export const env = createEnv({
    ...
    server: {
        ...
        LICENSE_DURATION: z.preprocess((val) => (val ? Number(val) : undefined), z.number().optional()),
    },
    /**
    ...
    client: {
        ...
        NEXT_PUBLIC_ENV_NAME: z
            .string()
            .optional()
            .transform((value) => value !== null && value !== void 0 ? value : (process.env.NODE_ENV === 'production'
        ...
        NEXT_PUBLIC_ENV_EMOJI: z
            ...
            .emoji()
            .optional()
            .transform((value) => value !== null && value !== void 0 ? value : (process.env.NODE_ENV === 'production' ? undefined : '🚧')),
        NEXT_PUBLIC_ENV_COLOR_SCHEME: z
            .string()
            .optional()
            .transform((value) => value !== null && value !== void 0 ? value : (process.env.NODE_ENV === 'production' ? 'success' : 'warning')),
        ...
        NEXT_PUBLIC_LICENSE_DURATION: z.preprocess((val) => (val ? Number(val) : undefined), z.number().optional()),
    },
    /**
